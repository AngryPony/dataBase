...
CREATE TABLE IF NOT EXISTS airoport (
    code INT PRIMARY KEY AUTO_INCREMENT NOT NULL UNIQUE,
    name VARCHAR(45) not null,
...
CREATE TABLE IF NOT EXISTS gate (
    id INT PRIMARY KEY AUTO_INCREMENT NOT NULL UNIQUE,
    name INT NOT NULL,
    type ENUM('SMALL', 'LARGE', 'MEDIUM') NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS flight (
    number INT PRIMARY KEY AUTO_INCREMENT NOT NULL UNIQUE,
  ...
  CREATE TABLE IF NOT EXISTS discount (
    discountCode INT PRIMARY KEY AUTO_INCREMENT NOT NULL UNIQUE,
    name VARCHAR(45) NOT NULL,
